        ...
        <div className="container mx-auto text-center">
          ...
          <div className="team grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="team-member bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              ...
              <h3 className="text-xl font-bold mt-2">Zubair Ahmed</h3>
            ...
            <Image
                ...
                height={300}
              />
              <h3 className="text-xl font-bold mt-2">Aliza Usman</h3>
              <p className="text-gray-600">Lead Developer</p>
            </div>
            <div className="team-member bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
            <Image
                ...
                height={300}
              />
              <h3 className="text-xl font-bold mt-2">Aleena Batool</h3>
              <p className="text-gray-600">Lead Developer</p>
            </div>
          </div>
        </div>
