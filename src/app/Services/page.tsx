        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaCode className="text-black text-4xl mb-4 my-auto mx-auto"/>
            ...
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaPaintBrush className="text-black text-4xl mb-4 my-auto mx-auto" />
            ...
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaMobile className="text-black text-4xl mb-4 my-auto mx-auto" />
            ...
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaMagnifyingGlass className="text-black text-4xl mb-4 my-auto mx-auto" />
            ...
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaCloud className="text-black text-4xl mb-4 my-auto mx-auto" />
            ...
            <div className="service-card bg-white p-6 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer transition ease-in-out delay-300">
              <FaDatabase className="text-black text-4xl mb-4 my-auto mx-auto" />
